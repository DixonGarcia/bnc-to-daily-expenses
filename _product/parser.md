...
| Any incoming credit (`credit > 0`, e.g. `"Credito Inmediato Recibido"`, `"Abono Pago Movil"`, `"Tranf. entre Ctas. Internet"`) | Passed through — triggers interactive prompt (new rate registration or omit) |
